...
class GameData extends DataTransferObject
{
    ...
    public static function fromApi(array $game): self
    {
        ...
        $game['genres'] = isset($game['genres']) ? implode(', ', collect($game['genres'])->pluck('name')->toArray()) : 'Not defined';
        $game['involved_companies'] = $game['involved_companies'][0]['company']['name'];
        $game['platforms'] = implode(', ', collect($game['platforms'])->pluck('abbreviation')->toArray());
